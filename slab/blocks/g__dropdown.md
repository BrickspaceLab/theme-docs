...
| Vertical direction | Controls whether the dropdown opens up or down | • Up (default)<br>• Down |
| Horizontal position | Controls horizontal positioning of the dropdown relative to the trigger | • Left (default)<br>• Center<br>• Right |
| Horizontal alignment | Controls horizontal alignment of the dropdown trigger | • Left (default)<br>• Center<br>• Right |
