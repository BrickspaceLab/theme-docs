...
|---------|-------------|---------|
| Overlay preset | Select a preset overlay ID or use a custom one | • Account<br>• Search<br>• Menu<br>• Primary cart<br>• Alternative cart<br>• Age verification<br>• Quick buy<br>• Quick edit<br>• Custom (default) |
