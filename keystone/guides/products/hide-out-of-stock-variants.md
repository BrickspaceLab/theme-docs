...
For advanced CSS customization beyond these settings, see our [advanced customization guide](../../../general/developer-guides/advanced-customizations/hide-out-of-stock-options.md).
